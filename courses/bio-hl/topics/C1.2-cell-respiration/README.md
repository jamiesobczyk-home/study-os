...
- **Level:** Molecules
- **Level of study:** SL and HL (the HL pathway detail is substantial)

- **Status:** ready

## The one-sentence version

Respiration is a controlled, stepwise way of getting the energy out of glucose
and into ATP — broken into stages not because biology likes complexity, but
because releasing it all at once would waste most of it as heat.

## Why this topic is hard, and what to do about it
