...
**Build the packs.** This is the real work, and it’s yours. A topic pack is
...
worked examples. The other 37 aren’t.

You don’t have to write them by hand. From a Claude session in this repo:
...
`study watch <topic>` prints the exact page range, so there’s no hunting. A
confidently wrong card gets memorized exactly as efficiently as a correct one,
and he won’t find out until an exam. The study guide is well suited to this:
it’s condensed and organized by the same topic codes, so verifying a pack's
...
**Don’t mark his cards.** Self-grading is part of the mechanism: judging
whether he actually knew something is itself a retrieval act, and it’s how he
...
isn’t trying. That’s the moment to get a teacher involved, and you’ll see
it weeks before a test would have told you.

## Where this could go wrong

**The packs don’t get built.** Most likely failure by far. The system does
